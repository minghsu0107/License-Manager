...
std::string XXTEA::base64_encode(unsigned char const* bytes_to_encode, unsigned int in_len) {
	std::string ret;
	int i = 0;
	int j = 0;
...
std::string XXTEA::base64_decode(std::string const& encoded_string) {
...
std::string XXTEA::xxtea_encrypt(std::string data, std::string key) {
...
std::string XXTEA::xxtea_decrypt(std::string data,  std::string key) {	
...
std::string XXTEA::string_To_UTF8(const std::string & str) {
...
std::string XXTEA::UTF8_To_string(const std::string & str) {
...
static xxtea_uint *xxtea_to_uint_array(unsigned char *data, xxtea_uint len, int include_length, xxtea_uint *ret_len) { 
...
static unsigned char *xxtea_to_byte_array(xxtea_uint *data, xxtea_uint len, int include_length, xxtea_uint *ret_len) { 
	xxtea_uint i, n, m; 
...
static unsigned char *do_xxtea_encrypt(unsigned char *data, xxtea_uint len, unsigned char *key, xxtea_uint *ret_len) { 
	unsigned char *result; 
...
static unsigned char *do_xxtea_decrypt(unsigned char *data, xxtea_uint len, unsigned char *key, xxtea_uint *ret_len) { 
	unsigned char *result; 
	xxtea_uint *v, *k, v_len, k_len; 
...
unsigned char *XXTEA::xxtea_encrypt(unsigned char *data, xxtea_uint data_len, unsigned char *key, xxtea_uint key_len, xxtea_uint *ret_length) { 
	unsigned char *result; 
...
unsigned char *XXTEA::xxtea_decrypt(unsigned char *data, xxtea_uint data_len, unsigned char *key, xxtea_uint key_len, xxtea_uint *ret_length) { 
	unsigned char *result; 
